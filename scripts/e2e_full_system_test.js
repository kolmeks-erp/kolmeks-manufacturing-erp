...
async function runE2ETests() {
  ...
  const endpoints = [
    ...
    { name: 'Payroll KPI Telemetry', path: '/api/payroll/dashboard' },
    ...
    { name: 'Quality NCR Records', path: '/api/quality/ncrs' },
    ...
    { name: 'Maintenance Telemetry', path: '/api/maintenance/kpis' },
    ...
    { name: 'Reports - Overview Telemetry', path: '/api/reports/telemetry' },
  ];
