      ...
      {error && (
        <div className="p-4 bg-rose-50 border border-rose-200 rounded-2xl text-rose-700 text-xs flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-0.5">Please check network or backend connection.</p>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
                ...
                <tr>
                  <td colSpan={9} className="py-16 text-center">
                    <div className="max-w-xs mx-auto text-center space-y-3">
                      ...
                      <h3 className="text-sm font-bold text-slate-800">No Purchase Requisitions Found</h3>
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-slate-50 border-t border-slate-200 text-xs">
          <div className="text-slate-500 font-medium">
            ...
            <span className="font-bold text-slate-900">{totalPages}</span> ({totalCount} requisitions)
          </div>
