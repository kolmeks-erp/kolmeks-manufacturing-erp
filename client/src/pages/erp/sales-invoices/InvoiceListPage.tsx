  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-[#0F2647] p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <span className="text-xs text-slate-500 dark:text-slate-400 mt-1 block">Across listed invoices</span>
        </div>
        ...
        <div className="bg-white dark:bg-[#0F2647] p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <span className="text-xs text-slate-500 dark:text-slate-400 mt-1 block">Receivable balance</span>
        </div>

        <div className="bg-white dark:bg-[#0F2647] p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Overdue Invoices</span>
            <div className="p-2 bg-rose-50 dark:bg-rose-950/50 text-rose-600 dark:text-rose-400 rounded-lg">
              <AlertCircle className="w-5 h-5" />
            </div>
          </div>
          <p className="text-2xl font-bold text-rose-600 dark:text-rose-400 mt-2">{overdueCount}</p>
          <span className="text-xs text-slate-500 dark:text-slate-400 mt-1 block">Requires payment collection</span>
        </div>
      </div>
        ...
        <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-slate-50 dark:bg-[#071220] border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 rounded-lg text-sm focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-3">
            <select
              ...
              className="px-3 py-2 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-lg text-sm focus:outline-hidden focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-[#071220]"
            >
            ...
            <select
              ...
              className="px-3 py-2 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-lg text-sm focus:outline-hidden focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-[#071220] max-w-[200px]"
            >
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-medium text-sm rounded-lg transition-colors"
            >
              Filter
            </button>
          </div>
        ...
        <div className="bg-white dark:bg-[#0F2647] rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 dark:bg-[#0B1E36] border-b border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-sm text-slate-700 dark:text-slate-300">
                {invoices.map((inv) => (
                  <tr key={inv.id} className="hover:bg-slate-50/80 dark:hover:bg-[#163761]/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-right">
                      <Link
                        ...
                        className="inline-flex items-center gap-1 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 bg-indigo-50 dark:bg-indigo-950/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 px-2.5 py-1.5 rounded-md transition-colors"
                      >
