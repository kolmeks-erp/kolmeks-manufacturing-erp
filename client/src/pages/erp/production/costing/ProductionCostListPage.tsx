    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 bg-slate-900 border border-slate-800 p-4 rounded-xl">
        ...
        >
          ...
          <option value="RELEASED font-medium">RELEASED</option>
                ...
                orders.map((ord) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="text-slate-200 font-medium">{ord.product?.name}</div>
                        <div className="text-xs text-slate-500">{ord.product?.product_code}</div>
                      </td>
                      <td className="p-4">
                        <span className="text-white font-medium">{ord.completed_quantity || 0}</span>
                        <span className="text-slate-500"> / {ord.planned_quantity} {ord.product?.unit}</span>
                      </td>
                      ...
                      <td className={`p-4 font-medium ${variance > 0 ? 'text-rose-400' : 'text-emerald-400'}`}>
