    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6 print:p-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 print:grid-cols-4">
        <div className="bg-white p-4.5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center justify-between">
          <div>
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Gross Asset Valuation</span>
            <div className="text-2xl font-extrabold text-slate-900 mt-1 font-mono tracking-tight">
              {loading ? '...' : formatCurrency(totalGrossCost)}
            </div>
            <div className="text-[11px] text-slate-400 mt-1">Acquisition Cost Basis</div>
          </div>
        ...
        <div className="bg-white p-4.5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center justify-between">
          <div>
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Accumulated Dep</span>
            <div className="text-2xl font-extrabold text-amber-600 mt-1 font-mono tracking-tight">
              {loading ? '...' : formatCurrency(totalAccumDep)}
            </div>
            <div className="text-[11px] text-amber-600 mt-1 font-medium">Total Depreciated Value</div>
          </div>
        ...
        <div className="bg-white p-4.5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center justify-between">
          <div>
            ...
            <div className="text-[11px] text-emerald-600 mt-1 font-medium">Carrying Balance Sheet Value</div>
          </div>
        ...
        <div className="bg-white p-4.5 rounded-2xl border border-slate-200/80 shadow-xs flex items-center justify-between">
          <div>
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Total Registered Assets</span>
            <div className="text-2xl font-extrabold text-indigo-600 mt-1 font-mono tracking-tight">
              {loading ? '...' : totalAssetUnits} <span className="text-xs text-slate-400 font-normal">units</span>
            </div>
            <div className="text-[11px] text-slate-400 mt-1">Across active categories</div>
          </div>
      ...
      {/* Tabs Control */}
      <div className="flex space-x-2 bg-slate-100/80 p-1.5 rounded-2xl border border-slate-200/80 print:hidden">
        <button
        ...
        >
          ...
          <span className="px-2 py-0.5 text-[10px] rounded-full bg-slate-100 text-slate-600 font-mono">
