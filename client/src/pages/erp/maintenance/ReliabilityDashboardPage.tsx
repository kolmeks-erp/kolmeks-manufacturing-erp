...
const ReliabilityDashboardPage: React.FC = () => {
  ...
  if (loading) return <LoadingState message="Calculating MTBF, MTTR & Asset Reliability telemetry..." />;
    ...
    <div className="space-y-6 animate-fadeIn w-full text-slate-800">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Asset Reliability & Telemetry Analytics</h1>
            <p className="text-sm text-slate-500 mt-0.5">
              Real-time MTBF, MTTR, Availability calculations, and recurring failure pattern identification
            </p>
          </div>
        </div>
        <button
