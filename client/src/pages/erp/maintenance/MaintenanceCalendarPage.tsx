...
const MaintenanceCalendarPage: React.FC = () => {
  ...
  if (loading) return <ERPLayout><LoadingState message="Loading maintenance calendar & schedule Timeline..." /></ERPLayout>;
  if (error) return <ERPLayout><ErrorState message={error} onRetry={fetchEvents} /></ERPLayout>;
