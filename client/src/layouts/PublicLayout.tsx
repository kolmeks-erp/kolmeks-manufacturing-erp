...
export const PublicLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans">
      ...
      <div className="bg-[#071220] text-slate-300 text-xs py-2 border-b border-slate-800">
        <Container className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-1.5 font-mono text-[11px] text-slate-400">
              <ShieldCheck className="w-3.5 h-3.5 text-blue-500" /> ISO 9001:2015 & ISO 14001 Standards Adherence
            </span>
            <span className="hidden md:flex items-center gap-1.5 font-mono text-[11px] text-slate-400">
              <Factory className="w-3.5 h-3.5 text-blue-500" /> Industrial Contract Manufacturing & Component Engineering
            </span>
          </div>
          <div className="flex items-center gap-4">
            <Link
              to={`${ERP_BASE_PATH}/login`}
              className="flex items-center gap-1 text-[11px] font-semibold text-blue-400 hover:text-white transition-colors"
            >
              <Lock className="w-3 h-3" /> Secure ERP Portal Access
            </Link>
          </div>
        </Container>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mb-3 leading-relaxed">
                Authorized staff portal for ERP telemetry, machine scheduling, and production management.
              </p>
              <Link
                to={`${ERP_BASE_PATH}/login`}
                className="inline-flex items-center gap-2 px-3 py-2 rounded bg-[#0B1E36] border border-slate-800 hover:border-blue-600 text-xs font-semibold text-white transition-colors"
              >
                <Lock className="w-3.5 h-3.5 text-blue-400" /> Kolmeks ERP Operations
              </Link>
            </div>
          </div>
